...
LRESULT CALLBACK PreviewProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam);
                            ...
                            WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_INITDIALOG:
		  ...
		  OldProc = (WNDPROC)SetWindowLongPtr(hCtrlBlock, GWLP_WNDPROC, (LONG_PTR)PreviewProc);
     ...
     case WM_COMMAND:
          ...
          case IDC_WHITE:
			   ...
			   InvalidateRect(hCtrlBlock, NULL, TRUE);
               return TRUE ;
...
LRESULT CALLBACK PreviewProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam) // PREVIEW PROC
{
	switch (iMessage)
	{
	case WM_PAINT:
