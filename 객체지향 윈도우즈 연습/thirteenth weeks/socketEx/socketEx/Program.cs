...
namespace socketEx
{
    class Program
    {
        static string _strHostName = "203.241.246.160";
       ...
       static void Main(string[] args)
    {
      ...
      r.Trying_to_connect(ref sckTcp,ref  ipEntry,ref ipEndPoint);
    }




        public void Trying_to_connect( ref Socket sckTcp,ref IPHostEntry ipEntry, ref IPEndPoint ipEndPoint){
            try{    // 소켓을 원격의 종점에서 연결을 시도한다.
